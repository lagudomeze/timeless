...
| **时间线** | [timeline.md](timeline.md) | 改决策槽、行动、前摇后摇、暂停与时钟 |

**专题篇**：

| 主题 | 文档 | 什么时候读 |
| :--- | :--- | :--- |
| 战斗 | [combat.md](combat.md) 🚧 | 改命中管线、对抗（打断 / 招架 / 格挡）、伤害与属性 |
| 技能 | [skills.md](skills.md) 🚧 | 加技能、改释放条件（`can_cast`）、阶段与效果 |
...
> 后者拆进各专题篇）。**新内容一律写进新篇**，这两篇只作历史参考，等替代完成即删除。
