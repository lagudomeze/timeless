//! # presentation — 表现领域（相机 / 模型 / 装饰 / UI / 日志）
//!
//! 「怎么给人看」：相机与灯光、单位模型、地表装饰、战斗日志（将来还有血条、
//! 动画、特效）。本域**只读**游戏状态、只写表现，不裁决规则、不改游戏数据。
//!
...
pub use camera::PanCamera;
pub use components::{CameraRig, HudLog, HudStatus, MainCamera};
